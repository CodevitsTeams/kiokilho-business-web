        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
          ...
          <div style={{ fontSize: '1.05rem', lineHeight: 1.8, display: 'flex', flexDirection: 'column', gap: '1.5rem', fontFamily: 'Outfit, sans-serif' }}>
            ...
            <div style={{ background: '#ffffff', padding: '2.5rem', borderRadius: '16px', border: '1px solid var(--border-color)', boxShadow: '0 4px 24px rgba(0,0,0,0.03)', marginTop: '1rem', marginBottom: '1rem' }}>
              ...
              <h4 style={{ fontSize: '1.4rem', fontWeight: 700, marginBottom: '0.5rem', color: 'var(--accent-color)' }}>PT Kinterraforé Technologies and Innovation</h4>
              
              <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem', marginTop: '1.5rem' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                  <strong style={{ minWidth: '90px' }}>Email:</strong>
                  <a href="mailto:hello@kinterrafore.com" style={{ color: 'var(--text-primary)', textDecoration: 'none', fontWeight: 500 }}>hello@kinterratechnologies.com</a>
                </div>
                <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                  <strong style={{ minWidth: '90px' }}>Instagram:</strong>
                  <a href="https://instagram.com/kinterratechnologies" target="_blank" rel="noopener noreferrer" style={{ display: 'flex', alignItems: 'center', gap: '4px', color: 'var(--text-primary)', textDecoration: 'none', fontWeight: 500 }}>
                    @kinterratechnologies
            ...
            <p>
              Sebagai arsitek platform, PT Kinterraforé Technologies and Innovation merancang arsitektur basis data yang tunduk pada kerangka kerja privasi global serta mengacu pada Undang-Undang Pelindungan Data Pribadi (UU PDP) di Indonesia. Seluruh proses penyimpanan identitas pelanggan dilakukan di dalam <em>bucket</em> terenkripsi dengan protokol <em>Row Level Security (RLS)</em> yang sangat ketat untuk mencegah kebocoran data (<em>data breach</em>).
            </p>
            ...
            <p>
              Platform e-commerce ini mengintegrasikan berbagai layanan pihak ketiga, termasuk namun tidak terbatas pada antarmuka kecerdasan buatan (<em>AI API</em>), pemrosesan pembayaran (<em>payment gateway</em>), dan agregator logistik pengiriman. Syarat penggunaan dan protokol keamanan dari layanan tersebut sepenuhnya tunduk pada penyedia masing-masing. PT Kinterraforé Technologies and Innovation dibebaskan dari tanggung jawab atas kerugian finansial maupun operasional yang timbul akibat malfungsi sistem pihak ketiga tersebut.
            </p>
